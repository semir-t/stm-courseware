...
#define FPU_TASK_STACK_SIZE 1024 
...
void blink1(void* p) 
{
	...
	while(1)
	{
		...
		if(lockUSART2() == 1)
		{
			printUSART2("-> This is task1. This Task will blink user LED diode. Current state of the LED is[%d]\n",state);
			unlockUSART2();
		}
	}
...
void blink2(void* p) 
{
	...
	while(1)
	{
		...
		if(lockUSART2() == 1)
		{
			printUSART2("-> This is task2. This Task will blink user LED diode. Current state of the LED is[%d]\n",state);
			unlockUSART2();
		}
